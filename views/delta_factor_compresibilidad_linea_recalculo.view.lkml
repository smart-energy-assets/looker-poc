# The name of this view in Looker is "Delta Factor Compresibilidad Linea Recalculo"
view: delta_factor_compresibilidad_linea_recalculo {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `target_reporting.delta_factor_compresibilidad_linea_recalculo`
    ;;
  ...
  dimension: error_z_neptuno {
    type: number
    sql: ${TABLE}.error_z_neptuno ;;
  }

  dimension: error_z_slm {
    type: number
    sql: ${TABLE}.error_z_slm ;;
  }

  dimension: error_zn_neptuno {
    type: number
    sql: ${TABLE}.error_zn_neptuno ;;
  }

  dimension: error_zn_slm {
    type: number
    sql: ${TABLE}.error_zn_slm ;;
  }
