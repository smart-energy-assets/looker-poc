# The name of this view in Looker is "Balances Section Energy Daily"
view: balances_section_energy_daily {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `sea-produccion.target_reporting.balances_section_energy_daily`
    ;;
